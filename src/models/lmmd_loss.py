...
def lmmd_loss(source_features, target_features, source_labels, target_pseudo_labels, 
              num_classes, kernel_mul=2.0, kernel_num=5, fix_sigma=None):
    """
    ...
    for c in range(num_classes):
        ...
        mmd_c = mmd_loss(source_features_c, target_features_c, 
...
def get_lmmd_loss(num_classes, kernel_mul=2.0, kernel_num=5, fix_sigma=None, weight=1.0):
    ...
    """
    def loss_fn(y_true, y_pred, source_features, target_features, source_labels, target_pseudo_labels):
        ...
        adapt_loss = lmmd_loss(
            ...
            num_classes, kernel_mul, kernel_num, fix_sigma
        )
